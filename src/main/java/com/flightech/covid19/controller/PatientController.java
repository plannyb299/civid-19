...
import com.flightech.covid19.service.PatientService;
...
public class PatientController {
	...
	@PostMapping
	public ResponseEntity<Patient> savePatient(@Valid @RequestBody Patient patient) throws IOException, WriterException {
